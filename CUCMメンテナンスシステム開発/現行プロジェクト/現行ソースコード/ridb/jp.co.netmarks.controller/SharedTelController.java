...
public class SharedTelController extends BaseController {
	...
	public ModelAndView sharedTelEdit(
			@Valid SharedTelUpdateForm form,
		...
		Map<String, String> messageMap =
				userAndTelSearchService.sharedTelEdit(params);
	...
	public ModelAndView sharedTelUpdate(
			@Valid SharedTelUpdateForm form,
			BindingResult result) throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
		...
		/* 属性更新処理 */
		Map<String, String> messageMap =
				userAndTelSearchService.sharedTelUpdate(params);
